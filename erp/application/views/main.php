    ...
    <div class="main-wrap cf">
      ...
      <ul class="quick-links">
        ...
        <li class="added-service">
			...
			<a tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="<?=site_url('settings/goods_list')?>"><span></span>商品管理</a>
        </li>
        <li class="feedback">
        	<a tabid="setting-customerList" data-right="BU_QUERY" tabTxt="客户管理" parentOpen="true" rel="pageTab" href="<?=site_url('settings/customer_list')?>"><span></span>客户管理</a>
        </li>
      </ul>
    </div>
  </div>
