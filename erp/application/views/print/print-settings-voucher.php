      ...
      <div class="item">
        ...
        <ul class="mod-form-rows" id="pdfSettings">
          <li class="row-item">
            ...
            <div class="ctn-wrap">
              <span class="radio-wrap"><input id="pp1" type="radio" name="paperType"  value="pp1" checked="checked"/><labe>A4</label>&nbsp;&nbsp;&nbsp;&nbsp;</span>
              <span class="radio-wrap"><input id="pp2" type="radio" name="paperType"  value="pp2"/><labe>1/2</label>&nbsp;&nbsp;&nbsp;&nbsp;</span><!-- //add by michen 20190218 -->
              <!--span class="radio-wrap"><input id="pp3" type="radio" name="paperType"  value="pp3"/><labe>1/3</label></span><!-- //add by michen 20190218 -->
            </div>
          </li>
          <!--<li class="row-item">
            <div class="label-wrap">
          ...
          <li class="row-item">
              ...
              <div class="tips">
                <ul>
				  ...
				  <li>TIPS:<点打印提示单据不存在时，请确认是否勾选订单></li>
                </ul>
              </div>
            </li>
        </ul>
 ...
 (function($){
    ...
    function init(){
      ...
      if (parent.parent.SYSTEM.serviceType == 8) {
        var taodaTips  = '您的帐套为免费版，须购买付费版才能使用套打功能，<a href="http://app.erp.com/site/buy.jsp" target="_blank">点击购买</a>'
    ...
    function initSettings(){
      ...
      $('#pdfEntrysPerNote').val($.cookie('entrysPerNote') || 20);

      $('#' + ($.cookie('paperType') || 'pp2')).attr('checked', 'checked');//add by michen 20190218
    ...
    function pdfPrint(){
      ...
      pdfData.paperType = $('input:radio:checked').val();//add by michen 20190218
