...
<?php for($t=1; $t<=$countpage; $t++){?>
		<table  width="800"  align="center">
			...
			<tr height="10px">
				<td align="center" style="font-family:'宋体'; font-size:10px; font-weight:normal;height:10px;"></td>
			</tr> 
		    <tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;"><?php echo $system['companyName']?></td>
			</tr> 
			<tr height="15px">
				<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;height:25px;"><?php echo $transType==150501 ? '采购入库单' :'购货退货单'?></td>
			</tr>
		</table>	
			   ...
			   ?>
				<tr style="height:20px">
				   <td width="30"  style="border:solid #000000;border-width:0 1px 1px 0;height:15px;font-family:'宋体'; font-size:12px;" align="center"><?php echo $row['i']?></td>
					<td width="220" align="left"><?php echo $row['goods'];?></td>
					<td width="30" align="center"><?php echo $row['mainUnit']?></td>
					<td width="40" align="center"><?php echo $row['qty']?></td>
					<td width="60" align="center"><?php echo $row['price']?></td>
					<td width="60" align="center"><?php echo $row['discountRate']?></td>
					<td width="50" align="center"><?php echo $row['deduction']?></td>
					<td width="60" align="center"><?php echo $row['amount']?></td>
