...
<div class="table-c">
        ...
        <td colspan="3" height="5px">
	     ...
	     <tr>
        <td   width= "220" rowspan="2" align="center" cellspacing="20"><img src="<?php echo base_url()?>/statics/css/img/logoly.png" alt=""   height="58"/></td> 
        ...
        <td   width= "450" align="center" style="font-family:'宋体'; font-size:17px; font-weight:normal;" >销售合同</td>  
		...
		<table  width="900" align="center">
			<tr height="15" align="left">
				...
				<td width="350" style="font-family:'宋体'; font-size:12px;height:25px;">客户签字：____________</td>
				<td width="100"></td>

				<td width="450" hight="88" align="left" style="font-family:'宋体'; font-size:12px;height:25px;">供货方签字：<img src="<?php echo base_url()?>/statics/css/img/gongzhang.png" alt=""   height="66px"/></td>
