...
<!--div class="table-c"-->
    <table width="800"  height="20" border="0" cellspacing="0" cellpadding="0" align="left">
       <tr>
             <td height="15" ></td>
         </tr>
     </table>   
      <br />
	<table width="800px"  height="180px" border="0" cellspacing="0" cellpadding="0" align="left">
		 <tr>
             <td height="5" ></td>
         </tr>
	     <tr>
		    ...
		    <td width="320" valign="top">
                 <table width="320" border="0" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
            			<td height="10" align="left"  style="font-family:'宋体'; font-size:12px; line-height:17px;font-weight:normal;height:17px;">地址：<?php echo $system['companyAddr']?></td>
            		</tr>
            		 <tr>
            			<td  height="10" align="left"  style="font-family:'宋体'; font-size:12px; line-height:17px;font-weight:normal;height:17px;">电话：<?php echo $system['phone']?></td>
            		</tr>
	        		 <tr>
	        			<td align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;" > 销售合同</td>
            		</tr>
        	...
        	<td width="5"></td>
         	...
         	<td width="220" valign="top" >
         		<table width="220" border="0" cellpadding="0" cellspacing="0" align="left">
            		...
            		<tr>
           				<td align="left"  style="font-family:'宋体'; font-size:12px; line-height:17px;font-weight:normal;height:17px;"> 编号：<?php echo $billNo?> </td>  
            		</tr>
            		...
            		<tr>
             			<td align="left" style="font-family:'宋体'; line-height:17px;font-size:12px; font-weight:normal;height:17px;" > 　单据日期：<?php echo $billDate?>
              			</td> 
              		</tr>
         		</table>
         	</td> 
     	</tr>
		    <!--tr width="800" height="15px">
			</td>
				<td align="left" style="font-family:'宋体'; font-size:15px; font-weight:normal;height:10px;"><img src="<?php echo base_url()?>/statics/css/img/logoly.png" alt=""  width="80" /></td>
			<td width="180" align="right" style="font-family:'宋体'; font-size:12px; font-weight:normal;height:12px;"></td>
				<td width="400" align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;"><?php echo $system['companyName']?>
				</td>
				<td width="200" align="left" style="font-family:'宋体'; font-size:12px; font-weight:normal;height:12px;">编号：<?php echo $billNo?>
				</td>
			</tr> 
			...
			<tr width="800" height="15px">
			<td width="180" align="center" style="font-family:'宋体'; font-size:12px; font-weight:normal;">
			</td>
				<td width="400" align="center" style="font-family:'宋体'; font-size:18px; font-weight:normal;">销售合同
				</td>
				<td width="140" align="left" style="font-family:'宋体'; font-size:12px; font-weight:normal;height:12px;">单据日期：<?php echo $billDate?></td>
			</tr--> 
