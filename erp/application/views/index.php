...
<div id="container" class="cf">
  ...
  <div id="col-main">
    <div id="main-hd" class="cf">
      ...
      <ul class="user-menu">
      	<li class="qq"><a href="" target="_blank" id="mobile" title="">进销存ERP</a></li>
      	<li class="space">|</li>
      	<!--<li class="qq"><a href="" onClick="return false;" id="wpa">QQ：123456</a></li>
      	<li class="space">|</li>
        
      	<li class="telphone">电话：123456789</li>
        <li class="space">|</li>-->
      	<li id="sysSkin">换肤</li>
        <li class="space">|</li>
