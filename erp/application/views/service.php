        ...
        <div class="service-box contact">
    		...
    		<ul class="list cf">
    			<li class="weixin">
    				<div class="inner">
    					<i></i>
	    				<p class="tit">售后热线：400-800-1234</p>
    			...
    			<li class="qq-club">
    				<div class="inner">
    					<i></i>
	    				<p class="tit">售后服务QQ：<a  title="在线QQ客服" id="wpa_shouhou" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=527329631&site=qq&menu=yes">527329631</a></p
>
