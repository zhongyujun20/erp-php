...
var dataReflush, list = {
	...
	JDStorageInvManage: {
		...
		purchasePre: {
            name: "物料预购",
            href: "../scm/invPuPre?action=initPur",
            dataRight: "PU_ADD",
            target: "purchase",
            list: "../scm/invPuPre?action=initPurList"
        },	
	purchase: {
		name: "采购入库单",
	...
	inventory: {
		...
		wwotherWarehouse: {
		name: "委外入库单",
		href: "../scm/invwwOi?action=initOi&type=wwin",
		dataRight: "IO_ADD",
		target: "storage",
		list: "../scm/invwwOi?action=initOiList&type=wwin"
	},
	wwotherOutbound: {
		name: "委外出库单",
		href: "../scm/invwwOi?action=initOi&type=wwout",
		dataRight: "OO_ADD",
		target: "storage",
		list: "../scm/invwwOi?action=initOiList&type=wwout"
	},
	otherWarehouse: {
		name: "其他入库单",
